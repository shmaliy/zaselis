...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . '/contents/' . $this->createSubdir() . '/flats/',
            'upload_url' => $domain . '/contents/' . $this->createSubdir() . '/flats/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
